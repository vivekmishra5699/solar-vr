...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ambientLight = new THREE.AmbientLight(0x404040, 1.45); // Soft white light
    ...
    function onDocumentMouseMove(event) {
        if (isDragging) {
            ...
            mercuryMesh.quaternion.multiplyQuaternions(deltaRotationQuaternion, mercuryMesh.quaternion);
